from love import pbot as app
from love.pyrogramee.errors import capture_err
from love.pyrogramee.json_prettify import json_prettify
from love.pyrogramee.fetch import fetch
