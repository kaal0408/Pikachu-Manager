...
from love.modules import ALL_MODULES
from love.modules.helper_funcs.chat_status import is_user_admin
from love.modules.helper_funcs.misc import paginate_modules
...
DONATE_STRING = """Visit to @Astro_UserBot // @Psycho_Bots ."""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("love.modules." + module_name)
...
•ADD me into your Group and Make me Admin🙂and let me do my work...in your group
   ~Thanks❤️~.""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ƁƛƇƘ 🧑‍🦼", callback_data="lobe_back"),
                    InlineKeyboardButton(text="𝚃&𝙲", callback_data="tc_"),
                 ]
                ]
            ),
        )
    elif query.data == "lobe_back":
        query.message.edit_text(
                PM_START_TEXT,
                reply_markup=InlineKeyboardMarkup(buttons),
                parse_mode=ParseMode.MARKDOWN,
    ...
    if query.data == "tc_":
        query.message.edit_text(
            text="""Hey...!\nɪ ᴀᴍ ғʀᴇᴇ ᴛᴏ ᴜsᴇ 
                ...
                •ᴅᴏɴ'ᴛ ᴜsᴇ ғᴏʀ sᴇxᴜᴀʟ ᴘᴜʀᴘᴏsᴇ
                •ᴡᴇ ʀᴇsᴘᴇᴄᴛ ʏᴏᴜʀ ᴘʀɪᴠᴀᴄʏ
                •ᴀʟʟ ʀɪɢʜᴛs ᴀʀᴇ ʀᴇsᴇʀᴠᴇᴅ ʙʏ  @Psycho_Bots™Hey...!\nɪ ᴀᴍ ғʀᴇᴇ ᴛᴏ ᴜsᴇ 
                ʙᴜᴛ ɪᴛ ᴅᴏᴇsɴ'ᴛ ᴍᴇᴀɴs ʏᴏᴜ ᴄᴀɴ ᴅᴏ ᴀɴʏᴛʜɪɴɢ
                •ᴅᴏɴ'ᴛ sᴘʀᴇᴀᴅ ᴘᴏʀɴᴏɢʀᴀᴘʜʏ...
                •ᴅᴏɴ'ᴛ ᴜsᴇ ғᴏʀ ᴀʙᴜsɪᴠᴇ ᴘᴜʀᴘᴏsᴇ
                •ᴅᴏɴ'ᴛ ᴜsᴇ ғᴏʀ sᴇxᴜᴀʟ ᴘᴜʀᴘᴏsᴇ
                •ᴡᴇ ʀᴇsᴘᴇᴄᴛ ʏᴏᴜʀ ᴘʀɪᴠᴀᴄʏ
                •ᴀʟʟ ʀɪɢʜᴛs ᴀʀᴇ ʀᴇsᴇʀᴠᴇᴅ ʙʏ  @Psycho_Bots™
                •ᴀʟʟ ᴛᴇʀᴍs ᴀɴᴅ ᴄᴏɴᴅɪᴛɪᴏɴs ᴀʀᴇ ᴀᴘᴘʟɪᴇᴅ©..""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Back", callback_data="lobe_")
                 ]
                ]
            ),
        )
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "I am Back⚡")
        except Unauthorized:
            LOGGER.warning(
