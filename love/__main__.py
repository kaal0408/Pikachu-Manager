...
# Psycho_Bots
# ©Alone_loverboy
# Keep This Line Kangers Else Your Mother Fuckes with everyone 😄
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            "I'm am Working well....\n<b>My Uptime:</b> <code>{}</code>".format(
                uptime
            ),
        ...
        if mod_match:
            ...
            query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="Bᴀᴄᴋ ᴛᴏ ᴍᴇɴᴜ", callback_data="help_back")]]
                ),
            )
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1258905497 and DONATION_LINK:
            update.effective_message.reply_text(
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Yep✨ I am Back....!")
        except Unauthorized:
            LOGGER.warning(
